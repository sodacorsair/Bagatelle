...
import { loginout } from '@/redux/demo/actionCreators';
import AuthModal from '../authModal';
import menus from './menus';

const Header = Layout.Header;

const NavBar = ({menus, menuCurSelKey, mode = 'horizontal', ...props}) => (
    <Menu mode={mode} defaultSelectedKeys={[menuCurSelKey]} {...props}>
        {menus.map(nav => (
            ...
            <Header className="header-container">
                <Row>
                    ...
                    <Col lg={{ span: 14 }} md={{ span: 14 }} xs={{ span: 0 }}>
                        <NavBar menus={menus} menuCurSelKey={this.props.location.pathname}/>
                    </Col>
                        ...
                        <Dropdown
                            overlay={
                                <NavBar
                                    mode="vertical"
                                    menus={menus}
                                    menuCurSelKey={this.props.location.pathname}
